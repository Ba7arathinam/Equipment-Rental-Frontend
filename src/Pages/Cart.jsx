  ...
  return (
    <div  style={{background:'black'}}>
      ...
      {!cartData || cartData.length === 0 ? (
        <div className="container text-center mt-5" style={{width:'100wh',height:'100vh'}}>

      <img style={{justifyContent:'center',alignItems:'center'}} src="https://cdni.iconscout.com/illustration/premium/thumb/confusing-woman-due-to-empty-cart-4558760-3780056.png" alt="" />
